...
function clinicaltrialobjectivelist(hObject, eventdata, h)
...
h.enterdirectory = uicontrol(h.radiogroup,...
    ...
    'String','Optional',...
    'Units', 'normalized', ...
    'Position',[0.01, 0.28, 0.4, 0.1]);

h.agreementoption = uicontrol(h.radiogroup ,...
    'Style','radiobutton',...
    'String',' Agreement',...
    'Units', 'normalized', ...
    'Position',[0.2 0.22 0.9 0.1],...
    'HandleVisibility','off');
