...
function associationlistproc(hObject, eventdata, h)
...
h.sample1 = uicontrol(h.radiogroup1 ,...
    'Style','radiobutton',...
    'String','    Both are Ordinal',...
    'Units', 'normalized', ...
    'Position',[0.25 0.75 0.92 0.2],'HandleVisibility','off');

h.sample2 = uicontrol(h.radiogroup1 ,...
    'Style','radiobutton',...
    'String','    Both are Continuous',...
    'Units', 'normalized', ...
    'Position',[0.25 0.55 0.92 0.2],'HandleVisibility','off');

h.sample4 = uicontrol(h.radiogroup1 ,...
    'Style','radiobutton',...
    'String','    One Continuous & One Binary',...
    'Units', 'normalized', ...
    'Position',[0.25 0.35 0.92 0.2],'HandleVisibility','off');

h.proceeddata = uicontrol(h.radiogroup1  ,'Style','pushbutton',...
    'String','Proceed',...
    'Units', 'normalized', ...
    'Position',[0.25 0.03 0.4 0.2]);

% Button Function
%-------------------------------------------------------------
set(h.proceeddata, 'callback',{@proceeddataassociationproc, h});
