...
function meanlistproc(hObject, eventdata, h)
...
h.var_unknown = uicontrol(h.radiogroup1,...
    'Style','radiobutton',...
    'String','Population variance is unknown (default)',...
    'Units', 'normalized', ...
    'Position',[0.15 0.75 0.92 0.2],'HandleVisibility','off');

h.var_known = uicontrol(h.radiogroup1,...
    'Style','radiobutton',...
    'String','Population variance is known',...
    'Units', 'normalized', ...
    'Position',[0.15 0.55 0.92 0.2],'HandleVisibility','off');

h.proceedbutton = uicontrol(h.radiogroup1 ,'Style','pushbutton',...
    'String','Proceed',...
    'Units', 'normalized', ...
...
% Button Function
%------------------
set(h.proceedbutton, 'callback',{@proceedvariance, h});
