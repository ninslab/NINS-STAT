...
function gobutton_tool_implement_proc_stack(hObject, eventdata, h)
...
if x_val == 1
    ...
    figure;bar(y_values, 'stacked'); % Stacked plot
    ...
    figure;bar(x_values, y_values, 'stacked'); % Stacked plot
