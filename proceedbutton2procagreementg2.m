...
function proceedbutton2procagreementg2(hObject, eventdata, h)
...
if valuesample3 == 1 && valuesample4 == 0
    ...
    h.var1value = uicontrol(h.panel12 ,...
        'Style','pushbutton',...
        'String','Upload Data',...
        'Units', 'normalized', ...
    ...
    h.var2value = uicontrol(h.panel12 ,...
        'Style','pushbutton',...
        'String','Upload Data',...
        'Units', 'normalized', ...
    ...
    set(h.rundata, 'callback',{@rundataprocagreementg2, h});
...
elseif valuesample3 == 0 && valuesample4 == 1
    ...
    set(h.var1value, 'callback',{@var1valueprocupload, h});
    set(h.rundata, 'callback',{@rundataprocagreementg2cat, h});
